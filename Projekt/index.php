  ...
  <body>
    ...
    <main>
      ...
      <article id="article">
        ...
        <section class="aktualnosci"><h3 class="h3_article">Responsywność strony!</h3>Przewidywana pod koniec roku!
        <section id="created_at_article">20/11/2422</section></section>

        <section class="aktualnosci"><h3 class="h3_article">Tytuł</h3>Tutaj będą dodawane aktualności!<section id="created_at_article">10/01/1002</section></section>
